...
// Upload certificate
export const uploadCertificate = createAsyncThunk<ICertificate, FormData, { rejectValue: string }>(
  "certificates/upload",
...
// Update certificate
export const updateCertificate = createAsyncThunk<ICertificate, { id: string; formData: FormData }, { rejectValue: string }>(
  "certificates/update",
  async ({ id, formData }, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(err.response?.data?.message || "Error updating certificate");
    }
  }
);

// Delete certificate
export const deleteCertificate = createAsyncThunk<string, string, { rejectValue: string }>(
  "certificates/delete",
