...
import { registerReff as register } from '../../redux/Slice/authSlice';
import { type RegisterPayload } from '../../redux/types/auth.types';
import { useNavigate } from 'react-router-dom';
import { useEmailValidator } from '../../api/useEmailValidator'; 

const RegisterReff: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await dispatch(register({ reff, data: formData })).unwrap();
      navigate('/');
    } catch (error) {
