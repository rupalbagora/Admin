...
import TermConditionForm, { TermCondition } from "./TermsConditionsForm";
...
const UploadTermConditions: React.FC = () => {
  ...
  // Table columns
  const columns = [
    { title: "Use of Services", dataIndex: "useOfServices", key: "useOfServices" },
    { title: "User Responsibilities", dataIndex: "userResponsibilities", key: "userResponsibilities" },
    { title: "Limitation of Liability", dataIndex: "limitationOfLiability", key: "limitationOfLiability" },
    { title: "Changes of Terms", dataIndex: "changesOfTerms", key: "changesOfTerms" },
    { 
      title: "Accepted", 
      dataIndex: "accepted", 
      key: "accepted",
