...
const TermConditionForm: React.FC<TermConditionFormProps> = ({
	onAddTermCondition,
}) => {
	...
	return (
		...
		>
			<Form.Item
				...
				name="useOfServices"
				rules={[
					{ required: true, message: "Please enter use of services details" },
				]}
			>
			...
			<Form.Item
				...
				rules={[
					{ required: true, message: "Please enter user responsibilities" },
				]}
			>
			...
			<Form.Item
				...
				rules={[
					{ required: true, message: "Please enter limitation of liability" },
				]}
			>
			...
			<Form.Item
				...
				name="changesOfTerms"
				rules={[
					{ required: true, message: "Please describe changes of terms" },
				]}
			>
				<TextArea
					rows={3}
					placeholder="Explain how changes of terms will be notified..."
				/>
			</Form.Item>
