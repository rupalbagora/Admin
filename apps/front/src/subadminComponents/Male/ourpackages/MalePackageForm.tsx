...
interface MalePackageFormProps {
  visible: boolean;
  onCancel: () => void;
...
const MalePackageForm: React.FC<MalePackageFormProps> = ({
  visible,
  onSubmit,
  initialData,
  //loading = false,
  ...
  return (
    ...
    >
      ...
      >
        <Input placeholder="Enter male package title" />
      </Form.Item>
...
export default MalePackageForm;